...
Tenancy is the concept of providing isolated access to resources. In the context of the Datum ecosystem, we are talking about the isolation of data and the ability to provide a single application to multiple tenants. The scope of this document is to provide a shared understanding and a working model for developing multi-tenant applications within the Datum ecosystem. It is outside the scope to discuss multi-tenancy in other systems beyond Datum except where drawing comparison helps to clarify our intent.
...
Services and applications in the Datum ecosystem will need to interact with multiple tenants. This will be done securely and with awareness.
