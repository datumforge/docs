...
Users will hold "memberships" to objects such as Groups, Organizations, Projects, etc. They will also hold ownership of resources which is the assignment of a role-level within Datum's authorization constructs, as the "parent" of resources within Datum are always the tenant(s) of the associated tree. 
