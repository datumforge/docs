...
description: ''
---
<Accordion title="What is Datum?">
  From the dictionary, `datum` means: _"a fixed starting point of a scale or operation"_, but in the context of this documentation, Datum is an early-stage software startup
</Accordion>
...
<CardGroup cols={2}>
  ...
  >
    Leading the transition to a more sustainable future through open source tooling, information / analytics, and innovation
  </Card>
  <Card
    title="Open Source"
    icon="code"
